...
const RenameModal = (props) => {
	...
	const marginBottom = bInterpolate(keyboardTransition, KEYBOARD_HEIGHT + 67, 67);
			...
			<TouchableWithoutFeedback onPress={onBackgroundTap}>
				<View style={styles.fullScreen}>
					...
					<Animated.View style={[ styles.container, modalTransitionStyle, bottomTransitionStyle ]}>
						<Text style={styles.inputTitle}>Rename File</Text>
						<TextInput
							value={inputValue}
							onChangeText={(text) => setInputValue(text)}
							style={styles.input}
						/>
						<ButtonOpacity title="Rename" style={{ paddingHorizontal: 20 }} onPress={onSubmit} />
					</Animated.View>
				</View>
